...
const cases = [
  ...
  ['heading', '<h2>Heading</h2>', 1.6, .5],
  ['heading1', '<h1>Heading one</h1>', 1.85, .5],
  ['heading3', '<h3>Heading three</h3>', 1.35, .5],
  ...
  ['toggle-heading', '<details><summary><h2>Heading section</h2></summary><p>Body</p></details>', 1.6, .65],
